  ...
  return (
    <div className={classes.wrapper}>
      ...
      <div className={classes.programBlock}>
        ...
        <div className={classes.block}>
          ...
          <div className={classes.result}>
            ...
            <div>
              {t("Закриєш всі питання в складних питаннях теоретичної частини")}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={classes.programBlock}>
        ...
        <div className={classes.block}>
          <div style={{ fontSize: 18, fontWeight: 700 }}>{t("Показовий")}</div>
          <div>
      ...
      <div className={classes.programBlock}>
        ...
        <div className={classes.block}>
          ...
          <div className={classes.result}>
            ...
            <div>{t("Навчишся створювати красивий та унікальний контент")}</div>
          </div>
        </div>
      </div>
      <div className={classes.programBlock}>
        ...
        <div className={classes.block}>
          <div style={{ fontSize: 18, fontWeight: 700 }}>{t("Чемпіонат")}</div>
